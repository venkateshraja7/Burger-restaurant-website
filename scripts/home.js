...
mainCourses.push({
    ...
    composition: "Soy sauce,Vegetable oil,Rice vinegar,Sesame oil,Green onions,Fresh ginger,Minced garlic",
    cost: "10.00$"
});

mainCourses.push({
    name: "Grilled Pizza",
    composition: "Fleischmann's® Pizza, sugar, salt,cup oil, pizza sauce,mozzarella cheese",
    cost: "11.00$"
});

mainCourses.push({
    name: "Salmon in Sun-dried Cream Sauce",
    composition: "Soy sauce,Vegetable oil,Rice vinegar,Sesame oil,Green onions,Fresh ginger,Minced garlic smoked paprika,red pepper flakes,Parmesan cheese",
    cost: "12.00$"
});

mainCourses.push({
    name: "Shrimp Scampi",
    composition: "Olive oilDry,white wine,Minced garlic,Parsley,Lemon,Parmesan,Pasta",
    cost: "15.00$"
});
